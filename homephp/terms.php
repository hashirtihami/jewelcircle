...
<div class="container" style="padding-top:50px">
  ...
  <h2 class="txt-center" style="color:#e60044;"> TERMS OF SERVICES </h2>
  <div style="padding-top:30px">

    <table class="table table-bordered" >
      <thead>
        <tr>
          <th class="txt-center" colspan="4" scope="col"><font>OVERVIEW</font></th>
        </tr>
      </thead>
      <tbody style="margin-bottom:30px">
        <tr>
          <td colspan="4">
            This website is operated by Jewel Circle. Throughout the site, the terms “we”, “us” and “our” refer to Jewel Circle. Jewel Circle offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.<br>
    ...
    <table class="table table-bordered" >
      <thead>
          <tr>
            <th colspan="4" scope="col"><font>SECTION 1 - ONLINE STORE TERMS</font></th>
          </tr>
      </thead>
      <tbody>
          <tr>
        ...
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 2 - GENERAL CONDITIONS </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 5 - PRODUCTS OR SERVICES (if applicable) </font>
            </th>
          </tr>
      </thead>
      <tbody>
          <tr>
            <td colspan="4">
              Certain products or services may be available exclusively online through the website. These products or services may have limited quantities and are subject to return or exchange only according to our Return& Exchange Policy.<br>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 7 - OPTIONAL TOOLS </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 8 - THIRD-PARTY LINKS </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 10 - PERSONAL INFORMATION</font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 12 - PROHIBITED USES</font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 14 - INDEMNIFICATION </font>
            </th>
          </tr>
      </thead>
      <tbody>
          <tr>
            <td colspan="4">
              You agree to indemnify, defend and hold harmless Jewel Circle and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
            </td>
          </tr>
      </tbody>
    </table>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 15 - SEVERABILITY</font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 16 - TERMINATION </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 17 - ENTIRE AGREEMENT</font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 18 - CHANGES TO TERMS OF SERVICE</font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 19 - CONTACT INFORMATION </font>
            </th>
          </tr>
      </thead>
      <tbody>
          <tr>
            <td colspan="4">
             Questions about the Terms of Service should be sent to us at Support@JewelCircle.net
            </td>
          </tr>
      </tbody>
    </table>
